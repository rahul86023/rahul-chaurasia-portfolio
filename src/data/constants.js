export const Bio = {
  ...
  resume: "/img/Rahul Chaurasia Resume.pdf",
  linkedin: "https://www.linkedin.com/in/rahul-chaurasia-997a56186/",
  twitter: "",
  insta:
    "https://www.instagram.com/rahul_chaurasia_96/?igshid=NzZlODBkYWE4Ng%3D%3D",
  facebook:
    "https://www.facebook.com/people/Rahul-Chaurasia/pfbid0cxiTpSipshgzuYUK8tWEMPLLr6toSWeEVnPsLhty8i4jpAzHdo9X3ZWbq9AXGkHKl/?mibextid=ZbWKwL",
};
...
export const experiences = [
  {
    ...
    desc: "Developed and maintained web applications using React.js and Node.js technologies for 1.3 years as an Associate Software Engineer.Participated in code reviews, identifying and resolving bugs to improve overall application performance.Implemented new features and enhancements, resulting in increased user engagement and satisfaction.",
    skills: [
      "React.js",
      "Redux Toolkit",
      "Javascript",
  ...
  },
  {
    ...
    desc: "Developed and implemented REST APIs using Node.js, Express.js, and MongoDB technologies for efficient data management.Implemented authentication and authorization mechanisms to ensure secure access to backend services.",
    skills: [
      "Node.js",
      "Express.js",
      "Mongoose",
...
export const education = [
  ...
  },
  {
    ...
    degree: "Bachelor Of Science-B.sc(C.S)",
  },
  {
    id: 2,
